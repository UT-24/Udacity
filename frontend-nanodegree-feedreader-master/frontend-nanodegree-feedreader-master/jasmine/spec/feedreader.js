    ...
    */
    ...
    describe('Intial Entries', function() {
        ...
        beforeEach(function(done) {
         ...
         it ('should load one feed', function(done) {
            var container = $('.feed');
    ...
    describe('New Feed Selection', function() {
         ...
         */
         var oldContainerHTML = $('.feed').html();
        ...
        it ('feed content should change when selection changed', function(done) {
            var container = $('.feed');
            expect(container).toBeDefined();
            newContainerHTML = container.html();   
            expect(newContainerHTML).toBeDefined();
